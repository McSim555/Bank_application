...
def main():
    ...
    k = 0
    while k < 1:
        status_choice_customer = input('Введите статус, по которому необходимо выполнить фильтрацию.\nДоступные для фильтровки статусы: EXECUTED, CANCELED, PENDING\n')
    ...
    while kkk < 1:
        ...
        if key_word_choice == "ДА":
            kkk += 1
            key_word = input('Введите описание искомых транзакций, например, "Перевод с карты на карту", "Перевод со счета на счет", "Открытие вклада", ... \n')
