...
def test_filter_by_currency(test_set_filter_by_currency):
    expected_result = [
        {
            "id": 939719570,
            "state": "EXECUTED",
    ...
    result = []
    for _ in range(2):
        result = list(filter_by_currency(test_set_filter_by_currency))
    assert expected_result == result


def test_filter_by_currency_other_currency(test_set_filter_by_currency):
    ...
    result = []
    for _ in range(2):
        result = list(filter_by_currency(test_set_filter_by_currency, 'RUB'))
    assert expected_result == result
